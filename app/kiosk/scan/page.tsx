  ...
  return (
    <KioskScanScreen
      ...
      copy={{
        ...
        scanRecommended: t("scanRecommended"),
        ...
        customerProgress: t("customerProgress"),
        customerProgressSuffix: t("customerProgressSuffix"),
        anonymousNote: t("anonymousNote", { restaurant: restaurant.name }),
        ratingFeeling1: t("ratingFeeling1"),
        ratingFeeling2: t("ratingFeeling2"),
        ratingFeeling3: t("ratingFeeling3"),
        ratingFeeling4: t("ratingFeeling4"),
        ratingFeeling5: t("ratingFeeling5"),
        overallTitle: t("overallTitle"),
        ...
        finish: t("finish"),
        finishDisabled: t("finishDisabled"),
        thanksTitle: t("thanksTitle"),
        thanksBody: t("thanksBody"),
        thanksResettingIn: t("thanksResettingIn"),
        thanksSecondsSuffix: t("thanksSecondsSuffix"),
